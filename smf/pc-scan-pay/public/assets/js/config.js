...
if (str === '/stag') {
  // stage2环境下的生产配置
  var commonUrl = 'https://pay.99bill.com/stage2/html/smf/pc-scan-pay.html';
  var config = {
  ...
  // prod环境下的生产配置
  var commonUrl = 'https://pay.99bill.com/prod/html/smf/pc-scan-pay.html';
  var config = {
  ...
  // prod环境下的生产配置
  var commonUrl = 'https://pay.99bill.com/sandbox/html/smf/pc-scan-pay.html';
  var config = {
    wxAppId: 'wxae9267e08251c228',
    zfbAppId: '2017090608586834',
    appId: 'coc-bill-api',
  ...
  var commonUrl = 'http://127.0.0.1:3000/pc-scan-pay.html';
  var config = {
