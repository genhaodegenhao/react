            ...
            buttons: (function () {
                ...
                if (typeof params.type === 'undefined' || params.type === 'numpad') {
                    ...
                    return [
                        ...
                        {
                            html: '<span class="picker-keypad-button-number '+ platformBg +'  link doAllThing ">完成</span>',
                            value: undefined
                        },
                        {
        ...
        p.initKeypadEvents = function () {
            ...
            function handleClick(e) {
                var buttonContainer = $(e.target);
                 ...
                 if(buttonContainer.hasClass('doAllThing')) {

                    let parentContainer = buttonContainer.parents('.picker-keypad-button');

                        if(parentContainer.hasClass('btn-ok-disabled')) {
                            return false;
