 ...
 * Fork on Framework7 Keypad 1.0.3
 */
 
    
let plugin = function (app) {
    'use strict';
    var $ = window.Dom7;
    ...
    let platformBg = platform == "WX"?'platformWX':'platformZhifubao';
    ...
    var Keypad = function (params) {
            ...
            buttons: (function () {
                ...
                if (typeof params.type === 'undefined' || params.type === 'numpad') {
                    ...
                    return [
                        ...
                        {
                            html: '<span class="picker-keypad-button-number '+ platformBg +' link btn-exit">完成</span>',
                            value: undefined
                        },
                        {
        ...
        p.initKeypadEvents = function () {
            ...
            function handleClick(e) {
                ...
                if(buttonContainer.hasClass('btn-exit')) {


                    var  parentBtn;
                    if(platform == "WX") {
                        parentBtn = buttonContainer.parents('.btn-ok-disabled-wx');
                    } else {

                        parentBtn = buttonContainer.parents('.btn-ok-disabled-ali');

                    }

                    

                    if(parentBtn.hasClass('btn-ok-disabled-wx')) {
                        return false;
                    }

                    if(parentBtn.hasClass('btn-ok-disabled-ali')) {
                ...
                if (p.params.type === 'numpad') {
                    ...
                    if (buttonContainer.hasClass('picker-keypad-pay')) {
                        // if(buttonContainer.hasClass('btn-ok-disabled')||
                        //    buttonContainer.hasClass('btn-ok-disabled-wx')||
                        //    buttonContainer.hasClass('btn-ok-disabled-alipay')||
                        //    buttonContainer.hasClass('picker-keypad-alipay-paying')||
                        //    buttonContainer.hasClass('picker-keypad-weixin-paying')||
                        //    buttonContainer.hasClass('picker-keypad-general-paying')){
                        //     return false
                        // }
                        // var numberMoney = $("#number").val().substring(1);
                        // if(buttonContainer.hasClass('btn-ok-alipay')){
                        //     $(".picker-keypad-pay").addClass("picker-keypad-alipay-paying");
                        // }else if(buttonContainer.hasClass('btn-ok-weixin')){
                        //     $(".picker-keypad-pay").addClass("picker-keypad-weixin-paying");
                        // }else{
                        //     $(".picker-keypad-pay").addClass("picker-keypad-general-paying");
                        // }
                        // $(".picker-keypad-pay .picker-keypad-button-number").html("正在支付")
                        // pay(numberMoney);
                    }
                    else {
                        if (typeof buttonValue !== 'undefined') {
                            if(buttonValue === '.' && currentValue.length==1){
                                currentValue = "¥0.";
                            }
                            if(buttonValue == '0' && currentValue.length==1){
                                currentValue = "¥0.";
                                buttonValue='';
                            }
                            if(currentValue.length==2&&currentValue=='¥0'&&buttonValue!=='.'){
                                currentValue = "¥";
                            }
                    ...
                    if (typeof currentValue !== 'undefined') 
                        p.setValue(currentValue.replace(/([0-9]+.[0-9]{2})[0-9]*/,"$1"));
                        // $$("#number1").focus();
                }
...
module.exports = function () {
    ...
    Framework7.prototype.plugins.keypad = plugin;
